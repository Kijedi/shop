						...
						<div class="row">
							...
							<div class="col-sm-9" id="header-right">
							     ...
							     <div class="search_form">
							      ...
							      <ul class="menu">
				                <li><a href="<?php echo $wishlist; ?>" id="wishlist-total"><i class="fa fa-heart-o"></i><span><?php echo $text_wishlist; ?></span></a></li>
				               	<li><a href="<?php echo $shopping_cart; ?>"><i class="fa fa-shopping-bag"></i><span><?php echo $text_shopping_cart; ?></span></a></li>
